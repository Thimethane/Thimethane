...
|:-----------|:------------|:---------|:------|
| [AI-Portfolio](https://github.com/Thimethane/AI-Portfolio) | Recruiter-ready portfolio with 27 documented AI projects, production-grade AI applications, a public GitHub, and a portfolio website. Positioned as an Applied AI Engineer integrating Data Science, Software Engineering, Cybersecurity, Computer Vision, and LLM development—offering a distinctive edge beyond a typical Python/ML profile. | — | ![](https://img.shields.io/github/stars/Thimethane/AI-Portfolio?style=flat-square&color=4fc3f7&labelColor=0d1117) |
